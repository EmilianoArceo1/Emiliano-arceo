...
public class ResetTablas {
    ...
    public static void crear(){
        try (Connection connection = getConexion()) {
            ...
            crearTabla(connection, "CarpentryProduction", "id INT AUTO_INCREMENT PRIMARY KEY, nombre VARCHAR(255),  codigo INT, done INT");
            ...
            crearTabla(connection, "Usuarios", "id INT AUTO_INCREMENT PRIMARY KEY, nombre VARCHAR(255),  usuario VARCHAR(255), contraseña VARCHAR(255), permisos INT, laboratorio VARCHAR(255)");
